...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Seller List</h1>
                </div>
            </div>
            ...
            <% 
				...
				%>
				<div style="float: right;"><a href="/Gym/sellerListExcel">Export to Excel</a></div>
					...
					%>
						<tbody>
							<tr>
								...
								<td><%= rs.getFloat("recived_amount") %></td>
	...
	<% 
		String str = (String)request.getAttribute("sellList");
		if(str != null)
		{
	%>
		alert("Your Excel Sheet stord in fallowing path \n C:\\Users\\Genius\\Documents\\SELLER_LIST_EXCEL.xlsx");
