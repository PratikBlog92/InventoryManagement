            ...
            <jsp:include page="temp.jsp"></jsp:include>
                ...
                <div id="page-wrapper">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header">Selling Bill</h1>
                            </div>
                        </div>
                                   ...
                                   session1.setAttribute("price", price);
                                    session1.setAttribute("quantity", quantity);
                                     session1.setAttribute("gst", gst);
                                      session1.setAttribute("discount", discount);
                                       session1.setAttribute("recived_amount", recived_amount);
                                        session1.setAttribute("total_amount", total_amount);
                                         session1.setAttribute("balence", balence);
                                          session1.setAttribute("note", note);
                                      
                            /* Add value to session END*/
                            
                    %>
                <form action="/Gym/sell" method="post">
                    <div class="row">
