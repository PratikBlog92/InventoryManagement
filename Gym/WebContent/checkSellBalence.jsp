            ...
            <jsp:include page="temp.jsp"></jsp:include>
                ...
                <div id="page-wrapper">
                    ...
                    <%
                        ...
                        PreparedStatement ps = con.prepareStatement("SELECT * FROM `seller` WHERE `balence` > 0");
                    ...
                    <div class="row">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    %>
                                        <tr>
                                            <td><a href="/Gym/clearSellBalence.jsp?id=<%=rs.getInt("id")%>"><%=rs.getString("seller_name")%></a></td>
