            ...
            <jsp:include page="temp.jsp"></jsp:include>
                ...
                <div id="page-wrapper">
                    ...
                    <%
                        ...
                        PreparedStatement ps = con.prepareStatement("SELECT * FROM `seller` WHERE id=?");
                        ps.setInt(1, id);
                       ResultSet rs = ps.executeQuery();
                       String balName=null;
                       int balTotal=0,balRECamount=0,balAmount=0;
                       while (rs.next()) {                               
                               balName = rs.getString("seller_name");
                               balTotal = rs.getInt("total_amount");
                               balRECamount = rs.getInt("recived_amount");
                    ...
                    <%
                        ...
                        PreparedStatement pst = co.prepareStatement("UPDATE `seller` SET `recived_amount`=?, `balence`=?  WHERE `id`= ?");
